...
class EchoMessageStub(object):
    ...
    def __init__(self, channel):
        ...
        self.echoMessage = channel.unary_unary(
                '/message.EchoMessage/echoMessage',
...
class EchoMessageServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_EchoMessageServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'message.EchoMessage', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('message.EchoMessage', rpc_method_handlers)
